...
input_path = r"C:\Users\Lenovo\Desktop\project\11.11\shijie_savemodels\allpeople_20836.xlsx"
...
rf = RandomForestClassifier(**rf_params, random_state=RANDOM_SEED, class_weight='balanced')
svm = SVC(**svm_params, probability=True, random_state=RANDOM_SEED, class_weight='balanced')
lr = LogisticRegression(**lr_params, random_state=RANDOM_SEED, class_weight='balanced')
xgb_model = xgb.XGBClassifier(**xgb_params, random_state=RANDOM_SEED, use_label_encoder=False,
                               eval_metric='mlogloss', scale_pos_weight=class_weight_dict[0] / class_weight_dict[1])
...
save_path_png = r"C:\Users\Lenovo\Desktop\project\11.11\shijie_savemodels\4ROC.png"  
save_path_pdf = r"C:\Users\Lenovo\Desktop\project\11.11\shijie_savemodels\4ROC.pdf"  

plt.savefig(save_path_png, dpi=300, bbox_inches='tight')  
plt.savefig(save_path_pdf, format='pdf', dpi=300, bbox_inches='tight')  

print(f"ROC : {save_path_png} and {save_path_pdf}")
plt.show()
