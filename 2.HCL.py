...
# 文件路径
input_paths = [
    r"G:\CVD\3.KNN\HCL\HCL1+不稳定心绞痛.xlsx",
    r"G:\CVD\3.KNN\HCL\HCL2+急性心肌梗死.xlsx",
    r"G:\CVD\3.KNN\HCL\HCL3+慢性缺血性心脏病.xlsx",
    r"G:\CVD\3.KNN\HCL\HCL4+脑梗死.xlsx",
    r"G:\CVD\3.KNN\HCL\HCL5+脑内出血.xlsx",
    r"G:\CVD\3.KNN\HCL\HCL6+脑血管病后遗症.xlsx",
    r"G:\CVD\3.KNN\HCL\2HCL7+总CVD.xlsx"
]
