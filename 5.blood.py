...
# 文件路径
input_path = r"G:\CVD\4.指标分离\总总-去重20836_血常规.xlsx"
...
X = data.iloc[:, 2:26]  # 第 3 列到第 24 列为特征
...
plt.title("Blood routine", fontsize=25)
...
# 保存图像为 PNG 和 PDF
save_path_png = r"G:\CVD\5.ROC\2.总3种模式\5blood-ROC.png"  # 修改为实际的路径
save_path_pdf = r"G:\CVD\5.ROC\2.总3种模式\5blood-ROC.pdf"  # 修改为实际的路径
